...
import { Button, Loading, ModalWrapper, Typography } from '../../shared';

import './BridgeModal.scss';

interface BridgePendingModalProps {
  open: boolean;
...
const BridgePendingModal: FC<BridgePendingModalProps> = ({
  open,
  fromNetwork,
  toNetwork,
  amount,
...
export default memo(BridgePendingModal);
